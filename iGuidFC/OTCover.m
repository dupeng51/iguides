...
- (OTCover*)initWithTableViewWithHeaderImageView:(UIImageView*)headerImageView tableview:(UITableView *) tabelview withOTCoverHeight:(CGFloat)height{
    
    CGRect bounds = [[UIScreen mainScreen] bounds];
    self = [[OTCover alloc] initWithFrame:bounds];
    
    self.headerImageView = headerImageView;
    [self.headerImageView setFrame:CGRectMake(0, 0, bounds.size.width, height)];
    self.OTCoverHeight = height;
...
{
    [self.headerImageView setImageWithURL:[NSURL URLWithString: imageUrl] placeholderImage:[UIImage imageNamed:@"placeholder.jpg"]];
}
