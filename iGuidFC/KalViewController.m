...
static const CGFloat kNavHeight = 50.f;
...
@synthesize dataSource, delegate, delegate1;
...
- (void)loadView
{
    if (!self.title)
        self.title = @"Calendar";
    CGRect frame= CGRectMake(0, kNavHeight, [[UIScreen mainScreen] applicationFrame].size.width, [[UIScreen mainScreen] applicationFrame].size.height - kNavHeight);
...
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent animated:YES];
    myNav = [[UINavigationBar alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, kNavHeight)];
...
//    [UINavigationBar appearance].barTintColor = [UIColor clearColor];
    ...
    UINavigationItem *navigItem = [[UINavigationItem alloc] initWithTitle:@"Select Date"];
...
{
    [delegate1 selectDate:self.beginDate end:self.endDate];
