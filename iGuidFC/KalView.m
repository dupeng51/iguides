...
- (id)initWithFrame:(CGRect)frame delegate:(id<KalViewDelegate>)theDelegate logic:(KalLogic *)theLogic
{
    if ((self = [super initWithFrame:frame])) {
        ...
        UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, kHeaderHeight)];
        [self addSubviewsToHeaderView:headerView];
        [self addSubview:headerView];
        
        UIView *contentView = [[UIView alloc] initWithFrame:CGRectMake(frame.origin.x, frame.origin.y+kHeaderHeight, frame.size.width, frame.size.height - kHeaderHeight-frame.origin.y)];
...
//    headerTitleLabel.textColor = kDarkGrayColor;
    ...
    NSString *titleText = [logic selectedMonthNameAndYear];
    [self setHeaderTitleText:titleText];
