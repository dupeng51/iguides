...
- (void)viewDidLoad
{
    ...
    FlightsVC *flightsVC = self.subViewControllers[0];
    [flightsVC activeView];
}
...
- (void)viewInit
{
    ...
    CGRect frame = CGRectMake(DOT_COORDINATE, DOT_COORDINATE, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT);
    if (self.customTopview) {
        frame = CGRectMake(DOT_COORDINATE, 104, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT);
    }
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:frame showArrowButton:_showArrowButton];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (_navTabBar.currentItemIndex != _currentIndex) {
        ...
        FlightsVC *flightsVC = self.subViewControllers[_currentIndex];
        [flightsVC activeView];
    }
...
- (void)itemDidSelectedWithIndex:(NSInteger)index
{
    ...
    FlightsVC *flightsVC = self.subViewControllers[index];
    [flightsVC activeView];
}
