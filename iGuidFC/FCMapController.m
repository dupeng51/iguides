...
#ifdef Yu
#define north 31.230170
#define south 31.226993
#define east 121.488945
#define west 121.486497
#endif

#ifdef LT
#define north 39.947887
#define south 39.943565
#define east 116.412736
#define west 116.409880
#endif
...
//                                                                 zoom:15];
    ...
    centrolPos = [FCMapController offsetCoordinate: CLLocationCoordinate2DMake(39.879932, 116.406763)];
    bearingValue = 0;
#endif
    ...
    centrolPos = [FCMapController offsetCoordinate: CLLocationCoordinate2DMake(31.228882, 121.487337)];
    bearingValue = 0;
    maxZoom= 18.5;
#endif
    ...
    centrolPos = [FCMapController offsetCoordinate: CLLocationCoordinate2DMake(39.945983, 116.410966)];
    bearingValue = 0;
    maxZoom = 20;
#endif
...
//    mapView_.settings.myLocationButton = YES;
    ...
    [mapView_ setMinZoom:zoomLevel maxZoom:maxZoom];
...
#ifdef SP_VERSION
    newLocation = [FCMapController offsetCoordinate:_currentLocation.coordinate];
...
-(BOOL)isOut:(CLLocationCoordinate2D) position
{
    ...
    CLLocationCoordinate2D southWest1 = [mapView_.projection coordinateForPoint:CGPointMake(southWestPoint.x, southWestPoint.y - butomView.frame.size.height)];
...
#ifdef LT
    northEast = CLLocationCoordinate2DMake(north, east);
    southWest = CLLocationCoordinate2DMake(south, west);
#endif
    if (position.latitude > northEast.latitude) {
        return YES;
    }
...
#endif
#ifdef Yu
    mapPosition = CLLocationCoordinate2DMake(31.226679, 121.491873);
    actualPosition = CLLocationCoordinate2DMake(31.228613, 121.487365);
    resultPosition = CLLocationCoordinate2DMake(position.latitude + (mapPosition.latitude - actualPosition.latitude), position.longitude + (mapPosition.longitude - actualPosition.longitude));
#endif
#ifdef LT
    mapPosition = CLLocationCoordinate2DMake(39.947271, 116.417570);
    actualPosition = CLLocationCoordinate2DMake(39.945864, 116.411310);
    resultPosition = CLLocationCoordinate2DMake(position.latitude + (mapPosition.latitude - actualPosition.latitude), position.longitude + (mapPosition.longitude - actualPosition.longitude));
#endif
